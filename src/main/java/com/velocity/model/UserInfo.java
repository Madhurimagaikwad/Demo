...
public class UserInfo {
	...
	public String toString() {
		return "UserInfo [id=" + id + ", fullName=" + fullName + ", email=" + email + ", password=" + password
				...
				+ refferalInfo + ", address=" + address + ", city=" + city + ", state=" + state + ", createdOn="
				+ createdOn + ", modifiedOn=" + modifiedOn + ", delete=" + delete + ", status=" + status + ", comments="
				+ comments + "]";
	}
